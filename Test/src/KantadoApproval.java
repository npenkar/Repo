...
public class KantadoApproval 
{
	public static void main(String[] args) throws InterruptedException, AWTException, Exception 
	{
		...
		String pendinglist = "https://admin-mkp.gem.gov.in//cms/admin/catalog_approval#!/oem_approval_index/catalogs?category_id=home_offi_offi_prin_comp&make=54422&dceo_view=false";
		int count = 1;
		String uname = Files.readAllLines(Paths.get("C:\\Np\\Dev\\Eclipse\\Repo\\Test\\resource\\KantadoApproval.txt")).get(0);
		String pwd = Files.readAllLines(Paths.get("C:\\Np\\Dev\\Eclipse\\Repo\\Test\\resource\\KantadoApproval.txt")).get(1);
		...
		driver.findElement(By.xpath("/html/body/div[1]/div[2]/div/div/div/oem-index-component/div/div[1]/div[2]/div[2]/select")).sendKeys("Kantado");
		Thread.sleep(500);
