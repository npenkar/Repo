...
public class BharatListing 
{
	...
	public static void main(String[] args) throws InterruptedException, AWTException, Exception 
	{
		...
		System.out.println("   ::Listing For Bharat in jeny brand ::");
		System.out.println("==> Enter BH = Bharat Listing ");
	    str = in.next();
	    Thread.sleep(500);
//	    if(str.contentEquals("VS") || str.contains("vs"))
//	    {
	    	Thread.sleep(500);
	    	System.out.println("==> Bharat ID Stock update selected ::: ");
	    	uname = Files.readAllLines(Paths.get("C:\\Np\\Dev\\Eclipse\\Repo\\Test\\resource\\BharatID.txt")).get(0);
			pwd = Files.readAllLines(Paths.get("C:\\Np\\Dev\\Eclipse\\Repo\\Test\\resource\\BharatID.txt")).get(1);
			System.out.println("...	Reading Username and Password from file ...	");
			System.out.println("Username  : " +uname);
			System.out.println("Password : " +pwd);
			
			File src = new File("C:\\Np\\Dev\\Eclipse\\Repo\\Test\\resource\\BharatModelNumber.xlsx"); 
...
//						{
						driver.findElement(By.xpath("//body/div[@id='page']/div[@id='bd']/div[@id='content-slot']/div[1]/div[1]/new-component[1]/div[1]/form[1]/uib-accordion[1]/div[1]/ng-form[1]/div[1]/div[2]/div[1]/fieldset[1]/div[3]/div[2]/select[1]")).click();	
						Thread.sleep(600);
						driver.findElement(By.xpath("//body/div[@id='page']/div[@id='bd']/div[@id='content-slot']/div[1]/div[1]/new-component[1]/div[1]/form[1]/uib-accordion[1]/div[1]/ng-form[1]/div[1]/div[2]/div[1]/fieldset[1]/div[3]/div[2]/select[1]")).sendKeys("jeny");	
						Thread.sleep(600);
//					    }
