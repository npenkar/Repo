...
//					
						...
						WebElement link = driver.findElement(By.xpath("/html/body/div[1]/div[3]/div/div/div/new-component/div/form/div[4]/div[3]/input"));
...
//						driver.findElements(By.xpath("//div[contains(text(),'SEARCH :')]")).size() != 0 ||
