...
//		Read ProductID from Excel
		File src = new File("C:\\Np\\Dev\\Eclipse\\OEMModel.xlsx"); 
...
//OEM SELECT			
						...
						driver.findElement(By.xpath("/html/body/div[1]/div[3]/div/div/div/new-component/div/form/uib-accordion/div/ng-form[3]/div/div[2]/div/fieldset/div[1]/div[2]/div/div[1]/input")).sendKeys("JAPAN");
						Thread.sleep(100);
						robot.keyPress(KeyEvent.VK_ENTER);
						robot.keyRelease(KeyEvent.VK_ENTER);
						Thread.sleep(100);
...
//						System.out.print(captchaTotext);
//					
//						driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[3]/div[1]/div[1]/div[1]/new-component[1]/div[1]/form[1]/div[4]/div[3]/show-captcha[1]/div[1]/div[2]/input[1]")).sendKeys(captchaTotext);
//						Thread.sleep(1500);
