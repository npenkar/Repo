...
public class BharatApproval 
{
	public static void main(String[] args) throws InterruptedException, AWTException, Exception 
	{
		...
		int count = 1;
		String uname = Files.readAllLines(Paths.get("C:\\Np\\Dev\\Eclipse\\Repo\\Test\\resource\\BharatApproval.txt")).get(0);
		String pwd = Files.readAllLines(Paths.get("C:\\Np\\Dev\\Eclipse\\Repo\\Test\\resource\\BharatApproval.txt")).get(1);
