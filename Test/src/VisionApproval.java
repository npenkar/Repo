...
public class VisionApproval 
{
	public static void main(String[] args) throws InterruptedException, AWTException, Exception 
	{
		...
		String pendinglist = "https://admin-mkp.gem.gov.in//cms/admin/catalog_approval#!/oem_approval_index/catalogs?category_id=home_offi_offi_prin_comp&make=39888&dceo_view=false";
		int count = 1;
		String uname = Files.readAllLines(Paths.get("C:\\Np\\Dev\\Eclipse\\Repo\\Test\\resource\\VisionApproval.txt")).get(0);
		String pwd = Files.readAllLines(Paths.get("C:\\Np\\Dev\\Eclipse\\Repo\\Test\\resource\\VisionApproval.txt")).get(1);
